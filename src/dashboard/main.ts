...
const ENEMIES: EnemyStat[] = [
  ...
  },
  {
    ...
    aggro: 250,
    attacks: [
      { label: "Overhead smash (88px reach, +300 knockback, +ENFEEBLE -30% dmg dealt × 6s)", damage: 98, telegraphMs: 780 },
  ...
  },
  {
    ...
    attacks: [
      ...
      { label: "Collapse slam (magic AoE 104px on transform-IN, +150 kb, +SILENCE 2.2s — dodge the tell)", damage: 26, telegraphMs: 560 },
  ...
  },
  {
    ...
    attacks: [
      ...
      { label: "Gorge Heave (190px radial SPACING shove, +620 kb, +DISARM 1.8s — it throws you out of melee, then you cannot swing on the way back in)", damage: 96, telegraphMs: 660 },
