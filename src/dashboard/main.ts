...
const ENEMIES: EnemyStat[] = [
  ...
  },
  {
    ...
    aggro: 160,
    attacks: [
      { label: "Pounce (locked leap, 190px band)", damage: 14, telegraphMs: 260 },
      { label: "Bite (point-blank fallback)", damage: 14, telegraphMs: 200 },
    ],
    loot: "1 Duskrunner Pelt",
    trophy: "Duskrunner Trophy (elite)",
    notes: "Biome 2 canid swarm. Fast, low-HP. Signature POUNCE gap-closer (sidestep-dodgeable) + point-blank bite. Pack-aggro (radius 260) — an aggro'd runner wakes packmates; spawns in packs of 3-4. Neutral resists (the AOE-arc payoff enemy).",
  },
  {
    ...
    aggro: 130,
    attacks: [
      { label: "Rolling charge (shell roll, 215px band)", damage: 22, telegraphMs: 560 },
      { label: "Heavy basher (point-blank + shove)", damage: 22, telegraphMs: 520 },
    ],
    loot: "1-2 Cragscale Plate",
    trophy: "Cragscale Trophy (elite)",
    notes: "Biome 2 armored bruiser (tanky, slow). Signature ROLLING CHARGE closes on kiters + a point-blank basher. Resist profile: slash ×0.5, blunt ×1.0, pierce ×1.6 — teaches the damage-type layer (Primal Spear shreds it, blades bounce).",
  },
  {
    ...
    speed: 62,
    aggro: 150,
    attacks: [{ label: "Magic bolt (projectile 240px, BYPASSES armor)", damage: 14, eliteScales: false }],
    loot: "1 Hex Essence",
    trophy: "Hexling Trophy (elite)",
    notes: "Biome 2 magical gremlin. Stand-and-cast kiter; magic bolt ignores flat armor. Signature BLINK — teleports ~215px when cornered (can't be simply run down). Resist profile: magic ×0.4, slash/blunt/pierce ×1.4 (weak to physical).",
  },
  {
