...
const PAGES: { title: string; lines: string[] }[] = [
  {
    ...
    lines: [
      ...
      "",
      "The game keeps growing between sessions — new biomes, bosses,",
      "and systems land regularly, so don't assume last time's build",
      "is this one.",
      "",
  ...
  },
  {
    ...
    lines: [
      ...
      "",
      "Not sure what a button or key does? Press Esc to pause, then",
      "open Tips for the full how-to-play reference — and the Keybinds",
      "panel (top-left, click to expand) always lists every control.",
      "We won't dump a wall of hotkeys on you here.",
    ],
  },
];
