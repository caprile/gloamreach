...
export const RECIPES: Recipe[] = [
  ...
  // === B4-P5: the MIREBRONZE branch. Each of these consumes its SUNSTEEL
  // counterpart, so the Sunsteel tier finally has somewhere to go without
  // passing through Embersteel. Same Workbench tier as the Gloamsteel line —
  // this is bayou-grade gear, just reached by the other road. ===
  {
    id: "mirebronze_helm",
    name: "Mirebronze Helm",
    description: "Resink a Sunsteel Helm in mirebronze.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_helm: 1, mirebronze_ingot: 2, mirehide: 2 },
    requiredSkills: [{ skill: "heavy_armor", level: 0 }],
    output: { kind: "item", itemId: "mirebronze_helm", itemName: "Mirebronze Helm" },
  },
  {
    id: "mirebronze_cuirass",
    name: "Mirebronze Cuirass",
    description: "Rework Sunsteel plate in mirebronze over a mirehide lining.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_cuirass: 1, mirebronze_ingot: 4, mirehide: 3 },
    requiredSkills: [{ skill: "heavy_armor", level: 0 }],
    output: { kind: "item", itemId: "mirebronze_cuirass", itemName: "Mirebronze Cuirass" },
  },
  {
    id: "mirebronze_greaves",
    name: "Mirebronze Greaves",
    description: "Resink Sunsteel Greaves in mirebronze.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_greaves: 1, mirebronze_ingot: 2, mirehide: 3 },
    requiredSkills: [{ skill: "heavy_armor", level: 0 }],
    output: { kind: "item", itemId: "mirebronze_greaves", itemName: "Mirebronze Greaves" },
  },
  {
    id: "bogweave_hood",
    name: "Bogweave Hood",
    description: "Reweave a Duskhide Hood with bog fibre and mirebronze rivets.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { duskhide_hood: 1, mirebronze_ingot: 1, swamp_moss: 3 },
    requiredSkills: [{ skill: "light_armor", level: 0 }],
    output: { kind: "item", itemId: "bogweave_hood", itemName: "Bogweave Hood" },
  },
  {
    id: "bogweave_vest",
    name: "Bogweave Vest",
    description: "Reline a Duskhide Vest with woven bog fibre.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { duskhide_vest: 1, mirebronze_ingot: 2, swamp_moss: 4, mirehide: 2 },
    requiredSkills: [{ skill: "light_armor", level: 0 }],
    output: { kind: "item", itemId: "bogweave_vest", itemName: "Bogweave Vest" },
  },
  {
    id: "bogweave_leggings",
    name: "Bogweave Leggings",
    description: "Reweave Duskhide Leggings in bog fibre.",
    category: "armor",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { duskhide_leggings: 1, mirebronze_ingot: 1, swamp_moss: 3 },
    requiredSkills: [{ skill: "light_armor", level: 0 }],
    output: { kind: "item", itemId: "bogweave_leggings", itemName: "Bogweave Leggings" },
  },
  {
    id: "mirebronze_warhammer",
    name: "Mirebronze Warhammer",
    description: "Resink a Sunsteel Warhammer in mirebronze.",
    category: "weapons",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_warhammer: 1, mirebronze_ingot: 3, bog_ore: 4 },
    output: { kind: "item", itemId: "mirebronze_warhammer", itemName: "Mirebronze Warhammer" },
  },
  {
    id: "mirebronze_sword",
    name: "Mirebronze Longsword",
    description: "Reforge a Sunsteel Longsword in mirebronze.",
    category: "weapons",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_sword: 1, mirebronze_ingot: 3, bog_ore: 3 },
    output: { kind: "item", itemId: "mirebronze_sword", itemName: "Mirebronze Longsword" },
  },
  {
    id: "mirebronze_pike",
    name: "Mirebronze Pike",
    description: "Resink a Sunsteel Pike in mirebronze.",
    category: "weapons",
    tier: 1,
    requiresWorkbenchTier: 4,
    costs: { sunsteel_pike: 1, mirebronze_ingot: 3, bog_ore: 3 },
    output: { kind: "item", itemId: "mirebronze_pike", itemName: "Mirebronze Pike" },
  },
  {
    id: "gloamsteel_helm",
